# -*- coding: utf-8 -*-
"""
Created on Wed Oct 27 16:01:35 2021
...
def onclick(choice, line):
    ...
    other = ['After that they sit to study', 'After that they ran away', 'After that they cooked food',
             'After that they quarreled', 'After that they wrote a poem']
...
frame2=Frame(root,bg="grey",relief="sunken",height="200",width="990")
frame1.grid(row=1)
frame2.grid(row=3,ipady=154,column=0,padx=120)
text_entry1=Label(frame1,text="Enter your text to story",font="comicsansms""bold").grid(row=1,column=2,padx=70,pady=50)
text_entry2=Label(frame1,text="Enter No. of lines story you want(1 to 4) ",font="comicsansms""bold").grid(row=2,column=2,padx=20,pady=50)
font_size=('normal',16)
